...
def check_pawn_attack(board, k, king_pos):
    ...
    if k is 'k':
        if 'P' in [king_pos[0]+1][king_pos[1]+1] in board:
            check=('k','P',king_pos[0]+1,king_pos[1]+1)
        elif 'P' in [king_pos[0]+1][king_pos[1]-1] in board:
            check=('k','P',king_pos[0]+1,king_pos[1]-1)
        else:
            check= None
    if k is 'K':
...
def check_knight_attack(board, k, king_pos):
    ...
    '''
    if k is 'k':
        if 'N' in [king_pos[0]+1][king_pos[1]+2] in board:
            check=('k','N',king_pos[0]+1,king_pos[1]+2)
        elif 'N' in [king_pos[0]+1][king_pos[1]-2] in board:
            check=('k','N',king_pos[0]+1,king_pos[1]-2)
