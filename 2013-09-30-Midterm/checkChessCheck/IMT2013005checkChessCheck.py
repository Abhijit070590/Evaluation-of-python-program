...
def check_pawn_attack(board, k, king_pos):
    ...
    if(k=='k'):
        if(board[king_pos[0]+1][king_pos[1]-1]=='P'):
            pawnP=(k,'P',king_pos[0]+1,king_pos[1]-1)
            return pawnP
        elif(board[king_pos[0]+1][king_pos[1]+1]=='P'):
            pawnP=(k,'P',king_pos[0]+1,king_pos[1]+1)
            return pawnP
        else:
            return check
...
def check_knight_attack(board, k, king_pos):
    ...
    if(k=='k'):
        if(board[king_pos[0]+2][king_pos[1]-1]=='N'):
            knightN=(k,'N',king_pos[0]+2,king_pos[1]-1)
            return knightN
            ...
            knightN=(k,'N',king_pos[0]-2,king_pos[1]+1)
            return knightN
        elif(board[king_pos[0]+1][king_pos[1]-2]=='N'):
            knightN=(k,'N',king_pos[0]+1,king_pos[1]-2)
            return knightN
        elif(board[king_pos[0]+1][king_pos[1]+2]=='N'):
            knightN=(k,'N',king_pos[0]+1,king_pos[1]-2)
            return knightN
...
def check_check(board):
    ...
    for k in king_pos:
        if 'k' in k:
            check_pawn_attack(board, 'k', king_pos['k'])
            check_knight_attack(board, 'k', king_pos['k'])
            t='Q'or'R'
            if(board[king_pos['k'][0]][king_pos['k'][1]+1]==t):
                return ('k',t,king_pos['k'][0],king_pos['k'][1]+1)
            elif(board[king_pos['k'][0]][king_pos['k'][1]-1]==t):
                return ('k',t,king_pos['k'][0],king_pos['k'][1]-1) 
            elif(board[king_pos['k'][0]-1][king_pos['k'][1]]==t):
                return ('k',t,king_pos['k'][0]-1,king_pos['k'][1])
            elif(board[king_pos['k'][0]+1][king_pos['k'][1]]==t):
                return ('k',t,king_pos['k'][0]+1,king_pos['k'][1])
            elif(board[king_pos['k'][0]-1][king_pos['k'][1]+1]==t):
                return ('k',t,king_pos['k'][0]-1,king_pos['k'][1]+1)
            elif(board[king_pos['k'][0]-1][king_pos['k'][1]-1]==t):
                return ('k',t,king_pos['k'][0]-1,king_pos['k'][1]-1) 
            elif(board[king_pos['k'][0]+1][king_pos['k'][1]-1]==t):
                return ('k',t,king_pos['k'][0]+1,king_pos['k'][1]-1)
